...
export class HomePage {
    ...
    protected showUsePictureButton: boolean;
    ...
    constructor(private navCtrl: NavController,
        ...
        this.showUsePictureButton = false;
    }
    ...
    takePicture(){
      ...
      this.showUsePictureButton = true;
      CameraPreview.takePicture({maxWidth: 640, maxHeight: 480});
      // Camera.getPicture({
